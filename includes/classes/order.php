...
class order extends base {
  ...
  function query($order_id) {
    ...
    $order_query = "select customers_id, customers_name, customers_company,
                         ...
                         date_purchased, orders_status, last_modified, order_total, order_tax, ip_address, cc_transactionid
                        from " . TABLE_ORDERS . "
    ...
    $this->info = array('currency' => $order->fields['currency'],
                        ...
                        'cc_transactionid' => $order->fields['cc_transactionid'],
                        // quickpay added end
...
*/
  ...
  function create($zf_ot_modules="", $zf_mode = 2) {
    ...
    if ($_SESSION['payment'] == 'quickpay_advanced' && $_SESSION['order_id']) {
        ...
        $transaction = $db->Execute("SELECT cc_transactionid FROM " . TABLE_ORDERS . " WHERE orders_id = '" . zen_db_input($_SESSION['order_id']) . "'");
        $this->info['cc_transactionid'] = $transaction->fields['cc_transactionid'];
