 ...
 * @copyright Copyright 2009 LAiKA iT
...
<?php
  echo zen_draw_form('checkout_confirmation', $form_action_url, 'post', 'id="checkout_confirmation" onsubmit="return submitonce(this);"');
...
?>
<div>
<b><?php echo ACCEPT_CONDITIONS; ?></b>&nbsp;<?php echo zen_draw_checkbox_field('agree','true', false); ?>
</div>
